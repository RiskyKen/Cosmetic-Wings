...
public class ModelMechWings extends ModelWingBase {
    
    ModelRenderer rightWing;
    ModelRenderer leftWing;
    private final ResourceLocation[] wingsImages;
    
    public ModelMechWings() {
        textureWidth = 64;
        textureHeight = 32;
        ...
        wingsImages[0] = new ResourceLocation(LibModInfo.ID.toLowerCase(), "textures/wings/mech-wings.png");
